...
(cl:defclass <CustomMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector rosbag_tools-msg:CustomPoint)
   :initform (cl:make-array 0 :element-type 'rosbag_tools-msg:CustomPoint :initial-element (cl:make-instance 'rosbag_tools-msg:CustomPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CustomMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CustomMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag_tools-msg:<CustomMsg> is deprecated: use rosbag_tools-msg:CustomMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag_tools-msg:header-val is deprecated.  Use rosbag_tools-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'timebase-val :lambda-list '(m))
(cl:defmethod timebase-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag_tools-msg:timebase-val is deprecated.  Use rosbag_tools-msg:timebase instead.")
  (timebase m))

(cl:ensure-generic-function 'point_num-val :lambda-list '(m))
(cl:defmethod point_num-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag_tools-msg:point_num-val is deprecated.  Use rosbag_tools-msg:point_num instead.")
  (point_num m))

(cl:ensure-generic-function 'lidar_id-val :lambda-list '(m))
(cl:defmethod lidar_id-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag_tools-msg:lidar_id-val is deprecated.  Use rosbag_tools-msg:lidar_id instead.")
  (lidar_id m))

(cl:ensure-generic-function 'rsvd-val :lambda-list '(m))
(cl:defmethod rsvd-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag_tools-msg:rsvd-val is deprecated.  Use rosbag_tools-msg:rsvd instead.")
  (rsvd m))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag_tools-msg:points-val is deprecated.  Use rosbag_tools-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CustomMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosbag_tools-msg:CustomPoint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CustomMsg>)))
  ...
  (cl:format cl:nil "# CustomMsg.msg~%~%~%Header header           # ROS standard message header~%~%uint64 timebase         # The time of first point~%~%uint32 point_num        # Total number of pointclouds~%~%uint8 lidar_id          # Lidar device id number~%~%uint8[3] rsvd           # Reserved use~%~%CustomPoint[] points    # Pointcloud data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rosbag_tools/CustomPoint~%# CustomPoint.msg~%~%~%uint32 offset_time              # Offset time relative to the base time~%~%float32 x                       # X axis coordinate, unit: m~%~%float32 y                       # Y axis coordinate, unit: m~%~%float32 z                       # Z axis coordinate, unit: m~%~%uint8 reflectivity              # Reflectivity, 0~~255~%~%uint8 tag                       # Livox tag~%~%uint8 line                      # Laser number in lidar~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CustomMsg)))
  "Returns full string definition for message of type 'CustomMsg"
  (cl:format cl:nil "# CustomMsg.msg~%~%~%Header header           # ROS standard message header~%~%uint64 timebase         # The time of first point~%~%uint32 point_num        # Total number of pointclouds~%~%uint8 lidar_id          # Lidar device id number~%~%uint8[3] rsvd           # Reserved use~%~%CustomPoint[] points    # Pointcloud data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rosbag_tools/CustomPoint~%# CustomPoint.msg~%~%~%uint32 offset_time              # Offset time relative to the base time~%~%float32 x                       # X axis coordinate, unit: m~%~%float32 y                       # Y axis coordinate, unit: m~%~%float32 z                       # Z axis coordinate, unit: m~%~%uint8 reflectivity              # Reflectivity, 0~~255~%~%uint8 tag                       # Livox tag~%~%uint8 line                      # Laser number in lidar~%~%~%"))
